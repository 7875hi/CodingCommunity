...
<body>
<form id="searchForm" action="/mypage/myreply" method="get">
<div class="search">
...
<h1 style="text-align: center;">내가 쓴 댓글의 글 목록</h1>
...
<table border=1 id = "list">
	...
	<tbody>
		<c:forEach var="myreply" items="${myreply}">
		
				<tr class = "tbody">
 				<td>${myreply.bno}</td>
  				<td class = "title"><a href="/detail?bno=${myreply.bno}">${myreply.reply}</a></td>
 				<td>${myreply.id}</td>
 				<td>${myreply.replaydate}</td>
