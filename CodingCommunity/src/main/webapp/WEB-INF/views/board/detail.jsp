...
<form action="/board/modify" method="post">
 <table border=1 class="detail">
        ...
        <tbody>
            ...
            <tr class="content">
                ...
                <td colspan="3" id="ci">
                    ...
                    <!-- <input name="content" value="${detail.content}" style="border:solid 1px black; float:left; width:100%; height:400px;"><br><br><br>-->	
                </td>
            </tr>
            <tr class="attach">
                <th>첨부파일</th>
	...
	<div>
    	...
    	<input type = "button" id="tolist" style="float: right;" onclick="location.href='/board/list'" value="목록으로">
    </div>
</form>
</div>
