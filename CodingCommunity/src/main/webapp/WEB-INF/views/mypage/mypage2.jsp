...
<div class="userinfo">
		<form action="/mypage2" method="post">
			...
			<div class="user_name">
			<p>이름 : <input type="text" name="name" value="${sessionScope.login.name}"></p>
			</div>
			<div class="user_pw">
			<p>비밀번호 : <input type="password" value="${sessionScope.login.password}" name="password"></p>
			</div>
			<div class="user_pw2"> <!-- 비밀번호와 동일해야함 -->
			<p>2차 비밀번호 : <input type="password" value="${sessionScope.login.password}"></p>
			</div>
			<div class="user_email">
			<p>E-mail : <input type="text" name="email" value="${sessionScope.login.email}"></p>
			</div>
...
<p><input type=submit class="w-btn w-btn-gray" value="회원탈퇴 »" formaction="/memberDelete"></p>
</form>
