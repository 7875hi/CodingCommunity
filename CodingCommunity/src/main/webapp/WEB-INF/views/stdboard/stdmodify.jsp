...
<form method="post">
 <table border=1 class="detail">
	...
	<div>
    		<button type = "submit" id="modifybtn" style="float: right;" formaction="/stdboard/stdmodify">수정 완료</button>
    		<button type = "submit" id="removebtn" style="float: right;" formaction="/stdboard/stdremove">삭제하기</button>
    </div>
</form>
</div>
</body>
