		...
		<div class="navbar">
			...
			<div class="navbar__menu">
				<ul id="ul">
					...
					<li id="li"><a href="/tipboard/tiplist">취업tip</a></li>
					<li id="li"><a href="/stdboard/stdlist">스터디</a></li>
					<li id="li"><a href="/shboard/shlist">지식공유</a></li>
		...
		<div class="slidewrap">
			<ul class="slidelist">
				<li><label for="slide03" class="left"><img
						...
						style="border-style: none;" alt="광고"></a> <label for="slide02"
					class="right"><img
			...
			<div class="recent_searches">
				...
				<div class="recent_searches_word">
					<ul>
						...
						<li>자바 <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>파이썬 <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>HTML <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>C++ <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>DB <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>이클립스 <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>개발자 <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>면접 <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
						<li>스터디 <input class="recent_searches_button" type="button"
							value="삭제">
						</li>
					</ul>
				</div>
		...
		<div id="rightbox">
			...
			<div class="card">
				...
				<div class="card_content">
					<ol start="1">
						<c:forEach var="stdtoptitle" items="${stdtoptitle}">
							<div class="toptitle">
								<li><a
									href="http://localhost:8080/stddetail?bno=${stdtoptitle.bno}">
										<div class="toptitle_p">
											<td>${stdtoptitle.title}</td>
										</div>
								</a></li>
							</div>
						</c:forEach>
			...
			<div class="card">
				...
				<div class="card_content">
					<ol start="1">
						<c:forEach var="shtoptitle" items="${shtoptitle}">
							<div class="toptitle">
								<li><a
									href="http://localhost:8080/shdetail?bno=${shtoptitle.bno}">
										<div class="toptitle_p">
											<td>${shtoptitle.title}</td>
										</div>
								</a></li>
							</div>
						</c:forEach>
